...
Polls curated YouTube channels via RSS, applies a two-stage relevance filter (keyword matching + metadata scoring), and triggers the full `/yt-intel` intelligence pipeline for qualifying videos.
